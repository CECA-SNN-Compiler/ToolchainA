...
parser.add_argument('--bitwidth',default=4,type=int)
...
best_acc=0
save_name='checkpoint/{}_{}b'.format(log_name,args.bitwidth)
def test(epoch):
    global best_acc
    net.eval()
    test_loss = 0
    ...
    if acc > best_acc:
        ...
        torch.save(net.state_dict(),save_name+'.pth')
        best_acc=acc
...
for epoch in range(0, args.epochs):
    ...
    test(epoch)
os.system('mv {} {}'.format(save_name+'.pth',save_name+'{:.3f}.pth'.format(best_acc)))